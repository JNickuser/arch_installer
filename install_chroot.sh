...
# Getting block devices from previous script
uefi=$(cat /var_uefi)
hd=$(cat /var_hd)
...
dialog --title "Continue installation" --yesno \
    ...
    10 60 && curl https://raw.githubusercontent.com/JNickuser/arch_installer/master/install_apps.sh \
    -o /tmp/install_apps.sh \
